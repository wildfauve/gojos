...
def selection(major):
    ...
    TEAM.major(major).add_to_roster(Matsuyama)
    TEAM.major(major).add_to_roster(Fleetwood)
    ...
    TEAM.major(major).add_to_roster(Koepka)
    TEAM.major(major).add_to_roster(Homa)
    TEAM.major(major).add_to_roster(Kim_S_W)
